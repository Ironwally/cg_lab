...
//Aufgabe 2
  TEST(SPHERE, intersects_Sphere_borderline_touching) {
  Sphere<float, 3> sphere = { {0.0, 0.0, 0.0}, 1.0};
  Sphere<float, 3> sphere2 = {{1.0, 0.0, 0.0}, 1.0};

  //distance
  EXPECT_EQ(true, sphere.intersects(sphere2));
}
  TEST(SPHERE, intersects_Sphere_borderline) {
  Sphere<float, 3> sphere = { {0.0, 0.0, 0.0}, 0.5};
  Sphere<float, 3> sphere2 = { {1.0, 0.0, 0.0}, 0.5};

  //distance
  EXPECT_EQ(true, sphere.intersects(sphere2));
}
  TEST(SPHERE, intersects_Sphere_borderline_not_touching) {
  Sphere<float, 3> sphere = { {0.0, 0.0, 0.0}, 0.4};
  Sphere<float, 3> sphere2 = { {1.0, 0.0, 0.0}, 0.5};

  //distance
  EXPECT_EQ(false, sphere.intersects(sphere2));
}
  TEST(SPHERE, intersects_Sphere_same_position) {
  Sphere<float, 3> sphere = { {0.0, 0.0, 0.0}, 1.0};
  Sphere<float, 3> sphere2 = { {0.0, 0.0, 0.0}, 1.0};

  //distance
  EXPECT_EQ(true, sphere.intersects(sphere2));
}
  TEST(SPHERE, intersects_Sphere_same_position_no_radius) {
  Sphere<float, 3> sphere = { {0.0, 0.0, 0.0}, 0.0};
  Sphere<float, 3> sphere2 = { {0.0, 0.0, 0.0}, 0.0};

  //distance
  EXPECT_EQ(true, sphere.intersects(sphere2));
}
  TEST(SPHERE, intersects_Sphere_same_position_no_radius_2) {
  Sphere<float, 3> sphere = { {0.0, 0.0, 0.0}, 0.0};
  Sphere<float, 3> sphere2 = { {0.0, 0.0, 0.0}, 1.0};
