...
// Aufgabe 1
// Mehr Tests für length(), square_of_length() und Skalarprodukt
  TEST(VECTOR, Length2D) {
  Vector2df vector = {3.0, 4.0};
  EXPECT_NEAR(5.0, vector.length(), 0.00001);
}

  TEST(VECTOR, Length3D) {
  Vector3df vector = {1.0, 2.0, 2.0};
  EXPECT_NEAR(3.0, vector.length(), 0.00001);
}
  ...
  TEST(VECTOR, SquareOfLength3D) {
  Vector3df vector = {1.0, 2.0, 2.0};
  EXPECT_NEAR(9.0, vector.square_of_length(), 0.00001);
}

  TEST(VECTOR, ScalarProduct2D_Orthogonal) {
  Vector2df vector1 = {1.0, 0.0};
  Vector2df vector2 = {0.0, 1.0};
  EXPECT_NEAR(0.0, vector1 * vector2, 0.00001);
}

  TEST(VECTOR, ScalarProduct2D_Parallel) {
  Vector2df vector1 = {1.0, 2.0};
  Vector2df vector2 = {2.0, 4.0};
  EXPECT_NEAR(10.0, vector1 * vector2, 0.00001);
}

  TEST(VECTOR, ScalarProduct3D) {
  Vector3df vector1 = {1.0, 0.5, 0.0};
  Vector3df vector2 = {1.0, 1.0, 0.0};
  EXPECT_NEAR(1.5, vector1 * vector2, 0.00001);
}
// Aufgabe 1 Ende
}
