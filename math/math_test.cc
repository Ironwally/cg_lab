...
TEST(VECTOR, CrossVectorProduct7) {
  ...
  //TODO
  Vector<float, 3u> vector = {38234628859811516925440.45645464489465, 338528859811704183484516925440.46546506500654654, 1.0};
  EXPECT_NEAR(38236127495295224000000000000000.0, vector.length(), 0.00001);
}
  ...
  TEST(VECTOR, ScalarProduct_randwertLow)
{
  ...
  EXPECT_NEAR(vector.length(), sqrt(vector.square_of_length()), 0.00001);
